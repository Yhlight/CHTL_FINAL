...
std::string CodeMerger::merge(const std::string& html_output, const std::vector<std::string>& css_outputs, const std::vector<std::string>& js_outputs) {
    std::string final_html = html_output;

    // Merge CSS from raw style blocks
