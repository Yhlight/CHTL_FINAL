...
int main() {
    std::cout << "=== Minimal Parse Element Test ===" << std::endl;
    ...
    std::cout << "Before parseElement - current_token_: " << parser.current_token_ << std::endl;
    std::cout << "Before parseElement - isAtEnd(): " << parser.isAtEnd() << std::endl;
