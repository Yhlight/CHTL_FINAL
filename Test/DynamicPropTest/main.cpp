...
int main() {
    std::string file_path = "Test/DynamicPropTest/main.chtl";
    ...
    std::string expected_html = R"(
        <html>
            <body>
                <div style="width:150px;height:75px;background-color:blue;"></div>
                <div style="width:80px;height:160px;background-color:green;"></div>
            </body>
        </html>
    )";
