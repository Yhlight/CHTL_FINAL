...
public:
    ...
    EvaluatedValue evaluate(Expr* expr, ElementNode* context, const std::map<std::string, EvaluatedValue>& static_props = {});
...
private:
    ...
    std::map<std::string, EvaluatedValue> current_static_props;
