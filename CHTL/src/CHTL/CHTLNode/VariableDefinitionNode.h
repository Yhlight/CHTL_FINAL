...
class VariableDefinitionNode : public BaseNode {
public:
    VariableDefinitionNode(std::string key, std::unique_ptr<Expr> valueExpr)
    ...
    std::unique_ptr<BaseNode> clone() const override {
        return std::make_unique<VariableDefinitionNode>(m_key, m_valueExpr->clone());
    }
